...
Want to see what the AI generates before setting it up? Download example resumes:

- **[📄 Resume PDF](outputs/resume.pdf)** - Example software engineer resume
- **[📄 Resume Word (.docx)](outputs/resume.docx)** - Editable Word format

These are real examples generated by the Resume Fine-Tuner agent!
